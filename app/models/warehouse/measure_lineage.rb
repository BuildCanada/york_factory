class Warehouse::MeasureLineage < Warehouse::Record
  TRANSITION_KINDS = %w[rename methodology_revision split merge unit_change scope_change revived].freeze

  belongs_to :predecessor, class_name: "Warehouse::Measure"
  belongs_to :successor, class_name: "Warehouse::Measure"
