...
--
-- Name: index_critiques_on_memo_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_critiques_on_memo_id ON public.critiques USING btree (memo_id);


--
-- Name: index_critiques_on_memo_id_and_linkedin_sub; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_critiques_on_memo_id_and_linkedin_sub ON public.critiques USING btree (memo_id, linkedin_sub);


--
-- Name: index_critiques_on_memo_id_and_status_and_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_critiques_on_memo_id_and_status_and_created_at ON public.critiques USING btree (memo_id, status, created_at);


--
-- Name: index_critiques_on_moderated_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_critiques_on_moderated_by_id ON public.critiques USING btree (moderated_by_id);


--
-- Name: index_endorsements_on_memo_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_endorsements_on_memo_id ON public.endorsements USING btree (memo_id);


--
-- Name: index_endorsements_on_memo_id_and_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_endorsements_on_memo_id_and_created_at ON public.endorsements USING btree (memo_id, created_at);


--
-- Name: index_endorsements_on_memo_id_and_linkedin_sub; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_endorsements_on_memo_id_and_linkedin_sub ON public.endorsements USING btree (memo_id, linkedin_sub);
...
--
-- Name: critiques fk_rails_19b861f779; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.critiques
    ADD CONSTRAINT fk_rails_19b861f779 FOREIGN KEY (moderated_by_id) REFERENCES public.users(id);


--
-- Name: endorsements fk_rails_2ce6592922; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.endorsements
    ADD CONSTRAINT fk_rails_2ce6592922 FOREIGN KEY (memo_id) REFERENCES public.memos(id);
...
--
-- Name: critiques fk_rails_fcbccc4e76; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.critiques
    ADD CONSTRAINT fk_rails_fcbccc4e76 FOREIGN KEY (memo_id) REFERENCES public.memos(id);
