...
parser = OptionParser.new do |opts|
  ...
  opts.on("--previous PATH", "Previous jurisdiction manifest for canonical-ID checks") do |value|
    options[:previous_path] = value
  end
...
builder = Warehouse::InstitutionRelease::MunicipalityManifestBuilder.new(
  base_path: base_path,
...
puts JSON.pretty_generate(
  ...
  "province" => output.fetch("province").fetch("code"),
